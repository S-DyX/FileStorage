...
namespace FileStorage.Core
{
	...
	public sealed class FileStorage : IFileStorage<string>
	{
		...
		private readonly IFileStorageLog _log;
		...
		{
			Save(file.Stream, file.Id);
			return file.Id;
		}

		void SaveStreamToFile(Stream stream, string fileName)
		{
		...
		/// <summary>
		/// <see cref="IFileStorage{TValue}.SaveToFile(byte[], string, bool)"/>
		/// </summary>
		/// <param name="bytes"></param>
		/// <param name="id"></param>
		/// <param name="close"></param>
		public void SaveToFile(byte[] bytes, string id, bool close)
		{
			SaveToFile(bytes, id, close, string.Empty);
		}
		/// <summary>
		/// <see cref="IFileStorage{TValue}.SaveToFile(byte[], string, bool, string)"/>
		/// </summary>
		/// <param name="bytes"></param>
		/// <param name="id"></param>
		/// <param name="close"></param>
		/// <param name="sessionId"></param>
		public void SaveToFile(byte[] bytes, string id, bool close, string sessionId)
		{
			var fileName = GetFullFileName(id, true);
			var fileInfo = new FileInfo(fileName);
			//if (fileInfo.Directory.Exists)
			{
				var tempFileName = GetTempFileName(fileName, sessionId);
				try
				{
		...
		/// <param name="id"></param>
		public void Append(byte[] array, string id)
		{
		...
		/// <param name="array"></param>
		/// <param name="id"></param>
		public void Save(byte[] array, string id)
		{
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public FileContainer Get(string id)
		{
		...
		/// <param name="id"></param>
		public void Save(Stream stream, string id)
		{
			var fullName = GetFullFileName(id, true);
			SaveStreamToFile(stream, fullName);
		}
		...
		/// <returns></returns>
		public FileToken SaveAsHash(Stream input)
		{
			var id = GetHash(input);
			return SaveStream(input, id);
		}
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public FileToken SaveStream(Stream input, string id)
		{
			Save(input, id);
